...
async function getYearlyEarnings() {
    ...
    let response = await fetch('https://dashboard.heroku.com/apps/isi-ticket-api/admin/getYearlyEarnings');
...
async function getMonthlyEarnings() {
    ...
    let response = await fetch('https://dashboard.heroku.com/apps/isi-ticket-api/admin/getMonthlyEarnings');
    let data = await response.json()
    console.log(data)
    return data;
}
...
async function getDailyEarnings() {
    ...
    let response = await fetch('https://dashboard.heroku.com/apps/isi-ticket-api/admin/getDailyEarnings');
    let data = await response.json()
    console.log(data)
    return data;
}
